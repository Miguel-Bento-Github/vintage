          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                <div className="bg-white rounded px-2 py-1 text-xs font-semibold text-gray-900">
                  Visa
                </div>
                <div className="bg-white rounded px-2 py-1 text-xs font-semibold text-gray-900">
                  Mastercard
                ...
                <div className="bg-blue-600 rounded px-2 py-1 text-xs font-semibold text-white">
                  PayPal
                </div>
              </div>
            </div>
